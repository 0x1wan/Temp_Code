...
public class Demigod extends BabySlime implements Adult {
    ...
    public Demigod(int fullness, int affinity, int stress, int hp, int speed, int attack, int defense, int magic) {
        super(fullness, affinity, stress);
        this.tribe = "데미갓"; 
        
        // 최종 진화 스탯 추가 (모든 스탯 +500)
        this.hp = hp + 500;
        this.speed = speed + 500;
        this.attack = attack + 500;
        this.defense = defense + 500;
        this.magic = magic + 500;
        
        System.out.println("\n[ 최종 진화 ] 모든 종의 기원이 강림합니다.");
    }
    ...
    public void nestprint() {
        System.out.println("\n[ 둥지 안착 효과 발동 ]");
        System.out.println("✨ 데미갓의 성스러운 후광이 세상을 비추며 날씨가 [ 광명 ] 상태로 고정됩니다!");
    }
