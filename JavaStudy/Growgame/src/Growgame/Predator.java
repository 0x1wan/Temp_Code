...
public class Predator extends BabyUndead implements Adult {
    ...
    public Predator(int fullness, int affinity, int stress, int hp, int speed, int attack, int defense, int magic) {
    ...
    public void nestprint() {
        System.out.println("\n[ 둥지 안착 효과 발동 ]");
        System.out.println("✨ 포식자의 굶주림이 주변 환경의 온도를 올려 [ 폭염 ] 상태로 변환됩니다.");
    }
