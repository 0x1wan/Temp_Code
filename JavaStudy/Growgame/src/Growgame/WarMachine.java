...
public class WarMachine extends BabyRobot implements Adult {
    ...
    public WarMachine(int fullness, int affinity, int stress, int hp, int speed, int attack, int defense, int magic) {
        ...
        // 최종 진화 스탯 추가 (공격력 +120)
        this.attack = attack + 120;
        
        System.out.println("\n[ 최종 진화 ] 전술적 포격 모드를 실행합니다!");
    }
    ...
    public void nestprint() {
        System.out.println("\n[ 둥지 안착 효과 발동 ]");
        System.out.println("✨ 워머신의 중화기 격발 충격이 전역 공격 훈련장을 자극합니다.");
    }
