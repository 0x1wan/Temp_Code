...
public class ElementDragon extends BabyDragon implements Adult {
    ...
    public ElementDragon(int fullness, int affinity, int stress, int hp, int speed, int attack, int defense, int magic) {
    ...
    public void nestprint() {
        System.out.println("\n[ 둥지 안착 효과 발동 ]");
        System.out.println("✨ 원소드래곤이 둥지를 틀어 주변 스탯 훈련 효율이 정제됩니다.");
    }
