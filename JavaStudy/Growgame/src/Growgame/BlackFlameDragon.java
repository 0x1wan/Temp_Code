...
public class BlackFlameDragon extends BabyDragon implements Adult {
    ...
    public BlackFlameDragon(int fullness, int affinity, int stress, int hp, int speed, int attack, int defense, int magic) {
        ...
        this.attack += 200;
        this.magic += 100;
        System.out.println("\n[ 최종 진화 ] 흑염룡이 세상을 찢어삼킬듯한 살기를 뿌립니다!");
    }
    ...
    public void nestprint() {
        System.out.println("\n[ 둥지 안착 효과 발동 ]");
        System.out.println("✨ 흑염룡의 검은 불꽃이 하늘을 가려 날씨가 [ 암전 ] 상태로 고정됩니다!");
    }
