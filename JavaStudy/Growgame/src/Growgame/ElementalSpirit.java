...
public class ElementalSpirit extends BabySpirit implements Adult {
    ...
    public ElementalSpirit(int fullness, int affinity, int stress, int hp, int speed, int attack, int defense, int magic) {
    ...
    public void nestprint() {
        System.out.println("\n[ 둥지 안착 효과 발동 ]");
        System.out.println("✨ 원소정령이 둥지에 안착하여 주변의 마나 흐름을 돕습니다.");
    }
