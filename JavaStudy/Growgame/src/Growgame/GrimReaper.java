...
public class GrimReaper extends BabyUndead implements Adult {
    ...
    public GrimReaper(int fullness, int affinity, int stress, int hp, int speed, int attack, int defense, int magic) {
    ...
    public void nestprint() {
        System.out.println("\n[ 둥지 안착 효과 발동 ]");
        System.out.println("✨ 사신의 낫이 시공을 가르며 날씨가 [ 종말 ], 필드가 [ 공허 ] 상태로 고정됩니다!");
    }
